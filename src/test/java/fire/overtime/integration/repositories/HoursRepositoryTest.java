...
//                firefighter, month, 24, WORK);
//        hoursService.saveHours(hoursSaveCommand);
//        hoursRepository.deleteByFirefighterIdAndStartDate(firefighter.getId(), DATE);
//        assertNull(hoursRepository.getHoursByStartDateAndFirefighterId(DATE, firefighter.getId()));
//    }
//
//
//
